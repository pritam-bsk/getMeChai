...
export const metadata = {
  title: "Buy me a chai",
  description: "Fund your ideas by your fans. Buy me chai to keep me going!",
};
  ...
  return (
    <html lang="en">
      ...
      >
        <SessionWrapper>
          <Navbar />
          <div className="min-h-[77vh] inset-0 -z-10 h-full w-full items-center [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
            {children}
          </div>
          <Footer />
        </SessionWrapper>
